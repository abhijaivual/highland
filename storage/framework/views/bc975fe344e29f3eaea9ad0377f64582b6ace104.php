...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/forms/icheck/icheck.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/forms/icheck/custom.css')); ?>">
    <!-- END VENDOR CSS-->
    <!-- BEGIN ROBUST CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/core/menu/menu-types/vertical-overlay-menu.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/pages/login-register.min.css')); ?>">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/style.css')); ?>">
    <!-- END Custom CSS-->
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="<?php echo e(URL::asset('logo.png')); ?>" alt="branding logo" class="img-responsive" width="200px" hieght="90px"></div>
                </div>
...
<?php endif; ?>
                <div class="card-block">
                    <form class="form-horizontal form-simple" action="<?php echo e(url('/login-process')); ?>"  method="post" novalidate>
    ...
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/forms/icheck/icheck.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/forms/validation/jqBootstrapValidation.js')); ?>" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    ...
    <script src="<?php echo e(URL::asset('app-assets/js/scripts/forms/form-login-register.min.js')); ?>" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
    <script>
