...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/bootstrap.min.css')); ?>">
      <!-- custom css link -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/custom.css')); ?>">
    <!-- font icons-->
           ...
           <!--    <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link"><i class="flag-icon flag-icon-gb"></i><span class="selected-language">English</span></a>
                        ...
                        <div class="media-body">
                          ...
                          <p class="notification-text font-small-3 text-muted"> <?php echo e($notification['data']['user']['id']); ?></p>
                           ...
                           //$diff=$created_at->diffForHumans($now);
                            ?>
                          <?php echo e($created_at); ?> Notifiyed
             ...
             <!--  <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
              ...
              <li class="dropdown dropdown-user nav-item">
                ...
                <a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?php echo e(URL::asset($profileimage)); ?>" alt=""><i></i></span><span class="user-name"><?php echo e($firstname); ?></span></a>
