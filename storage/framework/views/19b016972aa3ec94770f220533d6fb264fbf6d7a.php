				        ...
				        <tbody>
				            ...
				            <tr>
				            	 <td>
                                    ...
                                    <a href="<?php echo e(url('/view/attendance/'.$arr->empid.'/'.$arr->attid)); ?>">
				                  ...
				                  <td class="text-xs-center">
				                	<span class="avatar avatar-busy">
				                		...
				                		<img src="<?php echo e(URL::asset($arr->profile_image)); ?>" alt="" data-toggle="tooltip" data-placement="right" title="<?php echo e($arr->first_name); ?>"><i class=""><?php echo e($arr->id); ?></i>
                                        </a>
				                		<?php else: ?>
                                         <a href="<?php echo e(url('/employee/'.$arr->id)); ?>">
				                		<img src="<?php echo e(URL::asset('user.png')); ?>" alt="" data-toggle="tooltip" data-placement="right" title="<?php echo e($arr->first_name); ?>"><i class=""><?php echo e($arr->id); ?></i>
                                        </a>
				                		<?php endif; ?>
				                	</span>
				                </td>
				                ...
				                <td>
                                 ...
                                 <td><?php echo e($arr->att_date); ?></td>
                                    ...
                                    <td>
                                        <?php if(isset($attendance_empid) && $attendance_empid==$arr->empid): ?>
                                        <form method="post" action="<?php echo e(url('/edit-attendance/submit/')); ?>">
                                        <input type="text" name="in_time" value="<?php echo e($arr->in_time); ?>">
