        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Registration Process Step 2</h4>
                    <h4 class="card-title" style="color:green"><?php echo e($arr->profile_status); ?></h4>
                    ...
                    <div class="card-block">
                        ...
                        <form action="<?php echo e(url('/registration-2/submit')); ?>" method="post" class="number-tab-steps wizard-notification" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date1">Phone :</label>
                                                 <input type="text" value="<?php echo e($arr->phone); ?>" readonly="" class="form-control">
                                             </div>
                                    </div>
                                   <?php else: ?>
                                ...
                                <div class="row">
                                    <?php if(isset($arr->age)): ?>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date1">Age :</label>
                                                 <input type="text" value="<?php echo e($arr->age); ?>" readonly="" class="form-control">
                                             </div>
                                    </div>
                                   <?php else: ?>
                                    <div class="col-md-6">
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($arr->city)): ?>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date1">City :</label>
                                                 <input type="text" value="<?php echo e($arr->city); ?>" readonly="" class="form-control">
                                             </div>
                                    </div>
                                   <?php else: ?>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <?php if(isset($arr->gender)): ?>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date1">Gender :</label>
                                                 <input type="text" value="<?php echo e($arr->gender); ?>" readonly="" class="form-control">
                                             </div>
                                    </div>
                                   <?php else: ?>
                                    <div class="col-md-6">
                                    ...
                                    <?php if(isset($arr->address)): ?>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date1">Address :</label>
                                             <textarea name="address"  rows="4" class="form-control" readonly=""><?php echo e($arr->address); ?></textarea>
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if(isset($arr->reffered_by)): ?>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date1">Reffered By :</label>
                                                 <input type="text" value="<?php echo e($arr->reffered_by); ?>" readonly="" class="form-control">
                                             </div>
                                    </div>
                                   <?php else: ?>
                                    <div class="form-group">
...
<!-- upload multiple buttons end -->  
 ...
 <footer class="footer undefined footer-dark">
      <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2017 <a href="" target="_blank" class="text-bold-800 grey darken-2">Highland Hospital </a>, All rights reserved. </span><span class="float-md-right d-xs-block d-md-inline-block">VUAL <!-- <i class="icon-heart5 pink"></i> --></span></p>
    </footer>
