                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $designation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                <td><?php echo e($arr->desig_id); ?></td>
                                <td>
                                  <?php if(isset($desigid) && $desigid==$arr->desig_id): ?>
                                  <form method="post" action="<?php echo e(url('/edit-designation/submit/')); ?>">
                                  <input type="text" name="designation_name" value="<?php echo e($arr->designation_name); ?>">
                                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                  <input type="hidden" name="desig_id" value="<?php echo e($desigid); ?>">
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                      <a href="<?php echo e(url('/edit/designation/'.$arr->desig_id)); ?>"><button class="btn btn-info">Edit</button></a>
                                    <?php endif; ?>
                                </td>
                              <!--   <td><a href="<?php echo e(url('/remove/designation/'.$arr->desig_id)); ?>"><button class="btn btn-danger">Delete</button></a></td> -->
                              </tr>
                              </tr>
