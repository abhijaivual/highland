...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/pages/under-maintenance.min.css')); ?>">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/style.css')); ?>">
    <!-- END Custom CSS-->
  </head>
  <body data-open="hover" data-menu="horizontal-top-icon-menu" data-col="1-column" class="horizontal-layout horizontal-top-icon-menu 1-column bg-maintenance-image blank-page blank-page" style="background: #81c78438;">
    <!-- ////////////////////////////////////////////////////////////////////////////-->
        ...
        <div class="card border-grey border-lighten-3 px-1 py-1 box-shadow-3">
            <div class="card-block">
                <span class="card-title text-xs-center">
                    <img src="<?php echo e(URL::asset('logo.png')); ?>" class="img-fluid mx-auto d-block pt-2" width="150" alt="logo">
                </span>
            </div>
            <div class="card-block text-xs-center">
                <h3>Registration is successfull!

                HR will verifiy your Profile,Your Profile will be activated soon.</p>
                <div class="mt-2"><i class="icon-gear-a spinner font-large-2"></i></div>
            </div>
            <hr>
            <p class="socialIcon card-text text-xs-center pt-2 pb-2">
               <a href="<?php echo e(url('/logout')); ?>" class="btn btn-primary">Exit</a>
            </p>
        </div>
    </div>
</section>
