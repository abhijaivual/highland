...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/sliders/slick/slick.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/extensions/pace.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/charts/jquery-jvectormap-2.0.3.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/charts/morris.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/extensions/unslider.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/weather-icons/climacons.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/core/menu/menu-types/horizontal-top-icon-menu.min.css')); ?>">
    <!-- END VENDOR CSS-->

    <!-- BEGIN ROBUST CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/bootstrap-extended.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/app.min.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/colors.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/core/colors/palette-climacon.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/pages/users.min.css')); ?>">
    <!-- END Page Level CSS-->
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-bell4"></i><span class="tag tag-pill tag-default tag-danger tag-default tag-up"><?php echo e(count(auth()->user()->unreadNotifications)); ?> </span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  <li class="dropdown-menu-header">
                    <h6 class="dropdown-header m-0"><span class="grey darken-2">Notifications</span><span class="notification-tag tag tag-default tag-danger float-xs-right m-0"><?php echo e(count(auth()->user()->unreadNotifications)); ?> New</span></h6>
                  </li>
                  <li class="list-group scrollable-container">
                     <?php $__currentLoopData = json_decode(auth()->user()->unreadNotifications,true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="media">
                        ...
                        <div class="media-body">
                          ...
                          <p class="notification-text font-small-3 text-muted"> <?php echo e($notification['data']['user']['id']); ?></p>
                            <p class="notification-text font-small-3 text-muted"> <?php echo e($notification['data']['user']['first_name']); ?> &nbsp; 
                            <?php echo e($notification['data']['user']['last_name']); ?> </p>
                           <small> <time datetime="2015-06-11T18:29:20+08:00" class="media-meta text-muted">30 minutes ago</time></small>
                        </div>
                      </div></a>
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
               ...
               ?>
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?php echo e(URL::asset($profileimage)); ?>" alt=""><i></i></span><span class="user-name"><?php echo e($firstname); ?></span></a>
      ...
      <div data-menu="menu-container" class="navbar-container main-menu-content">
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
          <li class="dropdown nav-item" ><a href="/dashboard"  class="toggle nav-link"><i class="icon-home3"></i><span data-i18n="nav.dash.main">Dashboard</span></a>
            ...
            <?php if(Auth::check()): ?>
          <?php if(Auth::user()->r_id==2 || Auth::user()->r_id==3): ?>
            <li  class="dropdown nav-item"><a href="/registration/process-1/"  class="toggle nav-link"><i class="icon-home3"></i><span data-i18n="nav.dash.main">Registration</span></a>
          ...
          <?php if(Auth::check()): ?>
          <?php if(Auth::user()->r_id==3 || Auth::user()->r_id==2): ?>
          <li  class="dropdown nav-item"><a href="<?php echo e(url('/profile')); ?>"  class="toggle nav-link">
          <i class="icon-home3"></i><span data-i18n="nav.dash.main">Profile</span></a>
           </li>
           <?php endif; ?>
           <?php endif; ?>

            <?php if(Auth::check()): ?>
           <li  class="dropdown nav-item"><a href="<?php echo e(url('/myprofile/'.Auth::user()->id)); ?>"  class="toggle nav-link">
        ...
        <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="icon-paper-stack"></i><span data-i18n="nav.templates.main">Attendance</span></a>
            <ul class="dropdown-menu">
               <li data-menu="">
               <a href="<?php echo e(url('/upload-attendance')); ?>" data-toggle="dropdown" class="dropdown-item">Upload</a>
             </li>
              <li data-menu="">
               <a href="<?php echo e(url('attendance/table')); ?>" data-toggle="dropdown" class="dropdown-item">All Attendance</a>
             </li>
              <li data-menu="">
               <a href="<?php echo e(url('today/attendance/table')); ?>" data-toggle="dropdown" class="dropdown-item">Todays Attendance</a>
             </li>
          ...
          <?php endif; ?>
           ...
           <?php if(Auth::check()): ?>
          <?php if(Auth::user()->r_id==3): ?>
        <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="icon-paper-stack"></i><span data-i18n="nav.templates.main">Settings</span></a>
            <ul class="dropdown-menu">
               <li data-menu="">
               <a href="<?php echo e(url('/roles')); ?>" data-toggle="dropdown" class="dropdown-item">New Roles</a>
             </li>
             <li data-menu="">
               <a href="<?php echo e(url('/departments')); ?>" data-toggle="dropdown" class="dropdown-item">New Departments</a>
             </li>
             <li data-menu="">
               <a href="<?php echo e(url('/designations')); ?>" data-toggle="dropdown" class="dropdown-item">New Designations</a>
             </li>
            ...
            <ul class="dropdown-menu">
              <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu"><a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle">Page layouts</a>
                <ul class="dropdown-menu">
                  ...
                  <li data-menu=""><a href="layout-fixed-navbar.html" data-toggle="dropdown" class="dropdown-item">Fixed navbar</a>
                  </li>
                  <li data-menu=""><a href="layout-fixed-navigation.html" data-toggle="dropdown" class="dropdown-item">Fixed navigation</a>
                  </li>
                  <li data-menu=""><a href="layout-fixed-navbar-navigation.html" data-toggle="dropdown" class="dropdown-item">Fixed navbar &amp; navigation</a>
                  </li>
                  <li data-menu=""><a href="layout-fixed-navbar-footer.html" data-toggle="dropdown" class="dropdown-item">Fixed navbar &amp; footer</a>
                  </li>
                  <li class="dropdown-divider"></li>
          ...
          <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="icon-folder4"></i><span data-i18n="nav.category.general">General</span></a>
            <ul class="dropdown-menu">
              ...
              <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu"><a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle">Starter kit</a>
                <ul class="dropdown-menu">
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/horizontal-layout-1-column.html" data-toggle="dropdown" class="dropdown-item">1 column</a>
                  </li>
                  <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu"><a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle">Content Det. Sidebar</a>
                    <ul class="dropdown-menu">
                      <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-content-detached-left-sidebar.html" data-toggle="dropdown" class="dropdown-item">Detached left sidebar</a>
                      </li>
                      <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-content-detached-left-sticky-sidebar.html" data-toggle="dropdown" class="dropdown-item">Detached sticky left sidebar</a>
                      </li>
                      <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-content-detached-right-sidebar.html" data-toggle="dropdown" class="dropdown-item">Detached right sidebar</a>
                      </li>
                      <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-content-detached-right-sticky-sidebar.html" data-toggle="dropdown" class="dropdown-item">Detached sticky right sidebar</a>
                      </li>
                    </ul>
                  </li>
                  <li class="dropdown-divider"></li>
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-fixed-navigation.html" data-toggle="dropdown" class="dropdown-item">Fixed navigation</a>
                  </li>
                  <li class="dropdown-divider"></li>
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-fixed.html" data-toggle="dropdown" class="dropdown-item">Fixed layout</a>
                  </li>
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-boxed.html" data-toggle="dropdown" class="dropdown-item">Boxed layout</a>
                  </li>
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-static.html" data-toggle="dropdown" class="dropdown-item">Static layout</a>
                  </li>
                  <li class="dropdown-divider"></li>
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-light.html" data-toggle="dropdown" class="dropdown-item">Light layout</a>
                  </li>
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-dark.html" data-toggle="dropdown" class="dropdown-item">Dark layout</a>
                  </li>
                  <li data-menu=""><a href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/LTR/horizontal-top-icon-menu-template/layout-semi-dark.html" data-toggle="dropdown" class="dropdown-item">Semi dark layout</a>
                  </li>
                </ul>
              </li>
...
<?php echo $__env->yieldContent('content'); ?>
    ...
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/ui/jquery-sliding-menu.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/sliders/slick/slick.min.js')); ?>" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('app-assets/vendors/js/ui/jquery.sticky.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('app-assets/vendors/js/charts/jquery.sparkline.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/extensions/jquery.knob.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/js/scripts/extensions/knob.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/charts/raphael-min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/charts/morris.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/data/jvector/visitor-data.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/charts/chart.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/charts/jquery.sparkline.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/extensions/unslider-min.js')); ?>" type="text/javascript"></script>
    ...
    <script src="<?php echo e(URL::asset('app-assets/js/core/app-menu.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/js/core/app.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/js/scripts/ui/fullscreenSearch.min.js')); ?>" type="text/javascript"></script>
    <!-- /build-->
  ...
  <!--   <script src="<?php echo e(URL::asset('app-assets/js/scripts/pages/dashboard-analytics.min.js')); ?>" type="text/javascript"></script> -->
    <!-- END PAGE LEVEL JS-->
    <script>
