...
<?php $__env->startSection('content'); ?>
 ...
 <!-- <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/css/bootstrap.min.css')); ?>"> -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/forms/toggle/bootstrap-switch.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('app-assets/vendors/css/forms/toggle/switchery.min.css')); ?>">
...
<div class="content-body">
                ...
                <div class="media profil-cover-details">
                    ...
                    <div class="media-body media-middle row">
                        ...
                        <div class="col-xs-6 text-xs-right">
                            <?php if($arr->profile_status!="complete"): ?>
                            <a href="<?php echo e(url('/confirm/profile/'.$arr->id)); ?>"> 
                            ...
                            <i class="icon-minus4"></i> Cancel</button>
                             <?php endif; ?>


                            <div class="float-xs-right">
                                <input type="checkbox" class="switchBootstrap" data_src="<?php echo e($arr->id); ?>" value="1" id="switchBootstrap10" data-on-text="Enable" data-off-text="Disable" 
                                <?php  if($arr->profile_status=="activated")  echo 'checked'; ?>>
                            </div>
           ...
           <li class="timeline-item mt-3" style="text-decoration: none;" >
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <table class="table table-hover">
                <tr>
                  <td>First Name:</td>
                  <td><?php echo e($arr->first_name); ?></td>
                </tr>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <table class="table table-hover">
                <tr>
                  <td>Biodata:</td>
                  <td><a href="<?php echo e(url('upload/employee/'.$arr->id.'/'.$arr->cv)); ?>" download="" ><?php echo e($arr->cv); ?>

                  <a href="<?php echo e(url('/preview-pdf/'.$arr->id)); ?>"><button  class="btn btn-primary"> View </button></a> 
                  </td>
                </tr>

                <tr>
                  <td>Address Proof:</td>
                    <td><a href="<?php echo e(url('upload/employee/'.$arr->id.'/'.$arr->address_proof_doc)); ?>" download="" >
                    <?php echo e($arr->address_proof_doc); ?></td>
                </tr>

                <tr>
                  <td>Certificates:</td>
                    <td><a href="<?php echo e(url('upload/employee/'.$arr->id.'/'.$arr->certificate_doc)); ?>" download="" >
                    <?php echo e($arr->certificate_doc); ?></td>
                </tr>

                <tr>
                  <td>Expirience Letters:</td>
                    <td><a href="<?php echo e(url('upload/employee/'.$arr->id.'/'.$arr->expirience_doc)); ?>" download="" >
                    <?php echo e($arr->expirience_doc); ?></td>
                </tr>

                
                <tr>
                  <td>Pay-Slips:</td>
                    <td><a href="<?php echo e(url('upload/employee/'.$arr->id.'/'.$arr->payslip_doc)); ?>" download="" >
                    <?php echo e($arr->payslip_doc); ?></td>
                </tr>   
              </table>
        </div>
        </div>
             ...
             <li class="timeline-item mt-3" style="text-decoration: none;">
                ...
                <div class="timeline-card card border-grey border-lighten-2">
                    <div class="card-header" id="attendance">
                        <h4 class="card-title"><a href="#">Attendance</a></h4>
                        <p class="card-subtitle text-muted mb-0 pt-1">
                            <span class="font-small-3">18 June, 2016 at 4.50 P.M</span>
                        </p>
  ...
  <script src="<?php echo e(URL::asset('app-assets/vendors/js/forms/toggle/bootstrap-switch.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/forms/toggle/bootstrap-checkbox.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(URL::asset('app-assets/vendors/js/forms/toggle/switchery.min.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(URL::asset('app-assets/js/scripts/forms/switch.min.js')); ?>" type="text/javascript"></script>
