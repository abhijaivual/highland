...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-top-icon-menu-template/form-wizard-notification-style.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2018 06:13:07 GMT -->
<head>
    ...
    <title>Notification Style - Robust Bootstrap Admin Template</title>
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/css/core/menu/menu-types/horizontal-top-icon-menu.min.css">
            ...
            <ul class="dropdown-menu">
              ...
              <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu"><a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle">Form Wizard</a>
                <ul class="dropdown-menu">
                  ...
                  <li data-menu="" class="active"><a href="form-wizard-notification-style.html" data-toggle="dropdown" class="dropdown-item">Notification Style</a>
                  </li>
                </ul>
              </li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="c-select form-control" id="eventType1" data-placeholder="Type to search cities" name="eventType1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="c-inputs-stacked">
                                                <label class="c-input c-checkbox">
                                                  <input type="checkbox">
                                                  <span class="c-indicator"></span>1st item
                                                </label>
                                                <label class="c-input c-checkbox">
                                                  <input type="checkbox">
                                                  <span class="c-indicator"></span>2nd item
                                                </label>
                                                <label class="c-input c-checkbox">
                                                  <input type="checkbox">
                                                  <span class="c-indicator"></span>3rd item
                                                </label>
                                                <label class="c-input c-checkbox">
                                                  <input type="checkbox">
                                                  <span class="c-indicator"></span>4th item
                                                </label>
                                                <label class="c-input c-checkbox">
                                                  <input type="checkbox">
                                                  <span class="c-indicator"></span>5th item
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form action="#" class="vertical-tab-steps wizard-notification">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="c-select form-control" id="location3" name="location">
                                                <option value="">Select City</option>
                                                <option value="Amsterdam">Amsterdam</option>
                                                <option value="Berlin">Berlin</option>
                                                <option value="Frankfurt">Frankfurt</option>
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="jobTitle4">Job Title :</label>
                                            <input type="text" class="form-control" id="jobTitle4" >
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="c-select form-control" id="eventType4" data-placeholder="Type to search cities" name="eventType4">
                                                <option value="Banquet">Banquet</option>
                                                <option value="Fund Raiser">Fund Raiser</option>
                                                <option value="Dinner Party">Dinner Party</option>
                                                <option value="Wedding">Wedding</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="c-select form-control" id="eventLocation4" name="location">
                                                <option value="">Select City</option>
                                                <option value="Amsterdam">Amsterdam</option>
                                                <option value="Berlin">Berlin</option>
                                                <option value="Frankfurt">Frankfurt</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="c-select form-control" id="eventStatus4" name="eventStatus">
                                                <option value="Planning">Planning</option>
                                                <option value="In Progress">In Progress</option>
                                                <option value="Finished">Finished</option>
                                            </select>
...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-top-icon-menu-template/form-wizard-notification-style.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2018 06:13:08 GMT -->
</html>