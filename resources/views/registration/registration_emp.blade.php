        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4 class="card-title" style="color:green">{{$arr->profile_status}}</h4>
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        ...
                        <form action="{{ url('/registration-2/submit') }}" method="post" class="number-tab-steps wizard-notification" enctype="multipart/form-data">
