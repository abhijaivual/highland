...
<div class="content-body">
    @if(Auth::check())
    @if(Auth::User()->r_id==2 || Auth::User()->r_id==3)
<div class="row">
    <div class="col-xs-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-12 border-right-grey border-right-lighten-3 clearfix">
                            <div class="float-xs-left pl-2">
                                <span class="grey darken-1 block">Employee Profile</span>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-12 border-right-grey border-right-lighten-3 clearfix">
                            <div class="float-xs-left pl-2">
                                <span class="grey darken-1 block">Late Punch</span>
                                <span class="font-large-3 line-height-1 text-bold-300">85</span>
                            </div>
                            <div class="float-xs-left mt-2">
                                <span class="grey darken-1 block"></span>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-12 border-right-grey border-right-lighten-3 clearfix">
                            <div class="float-xs-left pl-2">
                                <span class="grey darken-1 block">Miss Punch</span>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-12 clearfix">
                            <div class="float-xs-left pl-2">
                                <span class="grey darken-1 block">Leave Request</span>
                                <span class="font-large-3 line-height-1 text-bold-300">2</span>
                            </div>
                            <div class="float-xs-left mt-2">
                                <span class="grey darken-1 block"></span>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Todays Attendance</h4>
            ...
            <div class="card-body collapse in">
              ...
              <a href="{{url('/employee/'.Auth::user()->id)}}">
